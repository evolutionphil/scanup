...
export default function DocumentsScreen() {
  ...
  const { documents, folders, isLoading, isSyncing, pendingSyncCount, isInitialCloudSyncing, fetchDocuments, fetchFolders, deleteDocument, updateDocument, deleteFolder, syncPendingDocuments, loadLocalCache, createFolder, forceRefreshFromCloud } = useDocumentStore();
  ...
  const renderEmptyState = () => (
    <View style={styles.emptyState}>
      <View style={styles.emptyIconWrapper}>
        <Ionicons name={activeMainTab === 'documents' ? "documents-outline" : "folder-outline"} size={56} color={theme.textMuted} />
      </View>
