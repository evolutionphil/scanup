...
DEFAULT_TRANSLATIONS = {
    ...
    "web_access_desc": "Manage web dashboard access requests",
    "secure_access_required": "Secure Access Required",
    "pending_requests": "Pending Requests",
    "no_pending_requests": "No Pending Requests",
    "no_pending_requests_desc": "When you sign in to the web dashboard, requests will appear here.",
    "approve": "Approve",
    "deny": "Deny",
    "access_granted": "Access Granted",
    "access_denied": "Access Denied",
    "web_access_approved_msg": "Web access has been approved. You can now view your documents on the web dashboard.",
    "web_access_denied_msg": "Web access request has been denied.",
    "revoke_all_access": "Revoke All Access",
    "revoke_all_confirm": "This will sign out all web sessions. Are you sure?",
    "all_sessions_revoked": "All web sessions have been revoked.",
    "security_tips": "Security Tips",
    "security_tip_1": "Only approve requests you initiated",
    "security_tip_2": "Check the IP address matches your location",
    "security_tip_3": "Deny suspicious or unknown requests",
    "security_tip_4": "Use \"Revoke All\" if you suspect unauthorized access",
    "request_expired": "Request expired",
    "session_expired_web": "Session expired",
...
DEFAULT_TRANSLATIONS_DE = {
    ...
    # Security & Web Access (Sicherheit & Web-Zugang)
    "security": "Sicherheit",
    "web_access": "Web-Zugang",
    "web_access_desc": "Web-Dashboard Zugriffsanfragen verwalten",
    "secure_access_required": "Sicherer Zugang erforderlich",
    "pending_requests": "Ausstehende Anfragen",
    "no_pending_requests": "Keine ausstehenden Anfragen",
    "no_pending_requests_desc": "Wenn Sie sich im Web-Dashboard anmelden, erscheinen Anfragen hier.",
    "approve": "Genehmigen",
    "deny": "Ablehnen",
    "access_granted": "Zugang gewährt",
    "access_denied": "Zugang verweigert",
    "web_access_approved_msg": "Web-Zugang wurde genehmigt. Sie können jetzt Ihre Dokumente im Web-Dashboard ansehen.",
    "web_access_denied_msg": "Web-Zugangsanfrage wurde abgelehnt.",
    "revoke_all_access": "Alle Zugänge widerrufen",
    "revoke_all_confirm": "Dies meldet alle Web-Sitzungen ab. Sind Sie sicher?",
    "all_sessions_revoked": "Alle Web-Sitzungen wurden widerrufen.",
    "security_tips": "Sicherheitstipps",
    "security_tip_1": "Genehmigen Sie nur von Ihnen initiierte Anfragen",
    "security_tip_2": "Prüfen Sie, ob die IP-Adresse Ihrem Standort entspricht",
    "security_tip_3": "Lehnen Sie verdächtige oder unbekannte Anfragen ab",
    "security_tip_4": "Verwenden Sie \"Alle widerrufen\" bei Verdacht auf unbefugten Zugriff",
    "request_expired": "Anfrage abgelaufen",
    "session_expired_web": "Sitzung abgelaufen",
...
DEFAULT_TRANSLATIONS_TR = {
    ...
    # Onboarding
    "onboarding_scan_title": "Tara",
    "onboarding_scan_desc": "Belgelerinizi kolayca taramak için telefon kameranızı kullanın",
    "onboarding_save_title": "Kaydet",
    "onboarding_save_desc": "Belgenizi PDF olarak kaydedin, şifreli dosyalar oluşturun ve paylaşın",
    "get_started": "Başla",
    ...
    "no_documents_desc": "Aşağıdaki kamera düğmesini kullanarak ilk belgenizi tarayın",
    "no_folders": "Henüz Klasör Yok",
    "no_folders_desc": "Belgelerinizi düzenlemek için klasörler oluşturun",
    "sort_by": "Sıralama",
    "sort_az": "A-Z",
    "sort_za": "Z-A",
    ...
    "set_password": "Şifre Koy",
    "remove_password": "Şifreyi Kaldır",
    "document_protected": "Korumalı Belge",
    ...
    "draw_signature": "İmza Çiz",
    "saved_signatures": "Kayıtlı İmzalar",
    "apply_all_pages": "Tüm sayfalara uygula",
    "manage_signatures": "İmzaları Yönet",
    "delete_signature": "İmzayı Sil",
    "no_signatures": "Kayıtlı İmza Yok",
    "create_first_signature": "İlk imzanızı oluşturun",
    ...
    "folder_password": "Klasör Şifresi",
    ...
    "premium_title": "Premium'u Aç",
    "premium_subtitle": "Tüm özelliklere erişin",
    "premium_feature_1": "Filigranı kaldır",
    "premium_feature_2": "Sınırsız tarama",
    "premium_feature_3": "Bulut yedekleme",
    "premium_feature_4": "Öncelikli destek",
    "monthly": "Aylık",
    "yearly": "Yıllık",
    "lifetime": "Ömür Boyu",
    ...
    "signature_saved": "İmza kaydedildi",
    "signature_applied": "İmza uygulandı",
    "changes_saved": "Değişiklikler kaydedildi",
    "delete_confirm": "Bunu silmek istediğinizden emin misiniz?",
    "delete_document_confirm": "Bu belgeyi silmek istiyor musunuz?",
    "delete_folder_confirm": "Bu klasörü ve tüm içeriğini silmek istiyor musunuz?",
    ...
    "deleting": "Siliniyor...",
    "selected": "seçili",
    "untitled_document": "Adsız Belge",
    "create": "Oluştur",
    "profile": "Profil",
    "guest_user": "Misafir Kullanıcı",
    "sign_in_to_sync": "Belgelerinizi senkronize etmek için giriş yapın",
    
    # Security & Web Access
    "security": "Güvenlik",
    "web_access": "Web Erişimi",
    "web_access_desc": "Web paneli erişim isteklerini yönetin",
    "secure_access_required": "Güvenli Erişim Gerekli",
    "pending_requests": "Bekleyen İstekler",
    "no_pending_requests": "Bekleyen İstek Yok",
    "no_pending_requests_desc": "Web panelinde oturum açtığınızda, istekler burada görünecektir.",
    "approve": "Onayla",
    "deny": "Reddet",
    "access_granted": "Erişim Verildi",
    "access_denied": "Erişim Reddedildi",
    "web_access_approved_msg": "Web erişimi onaylandı. Artık belgelerinizi web panelinde görüntüleyebilirsiniz.",
    "web_access_denied_msg": "Web erişim isteği reddedildi.",
    "revoke_all_access": "Tüm Erişimleri İptal Et",
    "revoke_all_confirm": "Bu işlem tüm web oturumlarını kapatacak. Emin misiniz?",
    "all_sessions_revoked": "Tüm web oturumları iptal edildi.",
    "security_tips": "Güvenlik İpuçları",
    "security_tip_1": "Yalnızca kendinizin başlattığı istekleri onaylayın",
    "security_tip_2": "IP adresinin konumunuzla eşleştiğini kontrol edin",
    "security_tip_3": "Şüpheli veya bilinmeyen istekleri reddedin",
    "security_tip_4": "Yetkisiz erişimden şüpheleniyorsanız \"Tümünü İptal Et\" kullanın",
    "request_expired": "İstek süresi doldu",
    "session_expired_web": "Oturum süresi doldu",
...
# Static pages via API routes
@api_router.get("/pages/contact")
@api_router.get("/pages/{lang}/contact")
async def serve_contact_page_api(lang: str = "en"):
    """Serve contact page via API route"""
    contact_path = os_module_pages.path.join(_landing_page_path, "contact.html")
    if os_module_pages.path.exists(contact_path):
...
async def serve_faq_page_api(lang: str = "en"):
    """Serve FAQ page via API route"""
    faq_path = os_module_pages.path.join(_landing_page_path, "faq.html")
    if os_module_pages.path.exists(faq_path):
...
async def serve_privacy_page_api(lang: str = "en"):
    """Serve privacy page via API route"""
    privacy_path = os_module_pages.path.join(_landing_page_path, "privacy.html")
    if os_module_pages.path.exists(privacy_path):
...
async def serve_terms_page_api(lang: str = "en"):
    """Serve terms page via API route"""
    terms_path = os_module_pages.path.join(_landing_page_path, "terms.html")
    if os_module_pages.path.exists(terms_path):
...
async def serve_support_page_api(lang: str = "en"):
    """Serve support page via API route"""
    support_path = os_module_pages.path.join(_landing_page_path, "support.html")
    if os_module_pages.path.exists(support_path):
...
if os_module.path.exists(landing_page_path):
    ...
    async def serve_faq_page():
        faq_path = os_module.path.join(landing_page_path, "faq.html")
        if os_module.path.exists(faq_path):
            return FileResponse(faq_path, media_type="text/html")
        raise HTTPException(status_code=404, detail="FAQ page not found")
